...
+ Кол-во тестовых машин и их IP адреса выбираются при запуске скрипта `/control/run_tests.sh`
...
<img src="docs/screenshots/test_architecture.png" alt="Схема архитектуры тестирования" width="600"/>
##### Участники
