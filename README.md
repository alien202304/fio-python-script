...
2. На все тестовые виртуальные машины необходимо скопировать скрипты из `scripts/` (при запуске стартового скрипта run_tests.sh на контрольном хосте, копирование актуальных версий тестовых скриптов производится автоматически)
