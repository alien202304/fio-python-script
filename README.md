...
- **Распределение IP адресации**
##### IPMI connect
+ 10.85.104.203 контроллер A ipmi
+ 10.85.104.204 контроллер B ipmi

##### WEB-GUI
+ 10.85.105.185 контроллер A web-gui
+ 10.85.105.186 контроллер B web-gui

##### iSCSI SFP
+ 10.85.109.11 контроллер A port 1
+ 10.85.109.12 контроллер A port 2

+ 10.85.109.13 контроллер B port 1
+ 10.85.109.14 контроллер B port 2
